...
import CustomModal from "@/components/utils/CustomModal/index";
...
export default function TalentSettings() {
  ...
  const handleChangePassword = async (e) => {
    ...
    try {
      setIsUpdating(true)
      await talentStore.updateTalentPassword(user, password, newPassword);
      showAlert(
        {
          type: "success",
          title: "Success!",
  ...
  const confirmDeleteAccount = async () => {
    try {
      ...
      await talentStore.deleteTalentAccount(user, deleteConfirmationPassword);
      showAlert(
        {
          type: "success",
          title: "Success!",
