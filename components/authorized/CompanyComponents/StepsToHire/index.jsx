...
export default function StepsToHire() {
  return (
    <section className={style.expect__section}>
      <div className={style.expect__header}>
        <h2 className={style.expect__title}>What to expect on our platform</h2>
        <p className={style.expect__subtitle}>
          We’re here to help you find the right talentss for your job openings.
          Here’s how our platform works, in a nutshell:
        </p>
      </div>
      <ul className={style.expect__list}>
        <li className={style.expect__step}>
          <span className={style.step__head}>Post your job openings</span>
          <p className={style.step__text}>
        ...
        <li className={style.expect__step}>
          <span className={style.step__head}>Review talents profiles</span>
          <p className={style.step__text}>
        ...
        <li className={style.expect__step}>
          <span className={style.step__head}>Manage interview requests</span>
          <p className={style.step__text}>
      ...
      <button className={style.learn__more}>Learn More</button>
    </section>
  );
}
